...
def main():
    ...
    xname = input('What is the new name for Jeff.obj? ') # collect string input from the user
    shutil.move('ceph_storage/Jeff.obj', 'ceph_storage/' + xname)  # moving kerrigan.obj into
